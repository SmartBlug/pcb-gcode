...
// 20170630: Created initial file for the NuggetMill to work properly with an "as simple as it gets" setup.
// 20170708: Removed the M2 command at the end of the gCode file which grbl doesn't like very much.
...
//string SPINDLE_ON     = "M3 " + SPINDLE_SPEED + EOL;
string SPINDLE_ON     = "M3" + EOL + DWELL;
